from pox.core import core  # Import POX core for controller functionality
import pox.openflow.libopenflow_01 as Of  # Import OpenFlow 1.0 library with alias Of
from pox.lib.addresses import EthAddr, IPAddr  # Import classes for Ethernet and IP addresses
import pox.lib.packet as Pkt  # Import packet library with alias Pkt for packet parsing and creation
import time  # Import time module for potential timing utilities

Log = core.getLogger()  # Global logger instance for logging controller events

# Configuration constants for load balancing
VirtualIp = IPAddr("10.0.0.10")  # Virtual IP address that clients will use to access the service
ServerIps = [IPAddr("10.0.0.5"), IPAddr("10.0.0.6")]  # List of backend server IP addresses
ServerMacs = [EthAddr("00:00:00:00:00:05"), EthAddr("00:00:00:00:00:06")]  # Corresponding MAC addresses for backend servers
